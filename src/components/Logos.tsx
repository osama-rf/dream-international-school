...
const Logos: React.FC<{ locale: Locale }> = ({ locale }) => {
    ...
    return (
        <section id="logos" className="py-12 sm:py-16 bg-background">
            <div className="max-w-6xl mx-auto px-4 sm:px-5">
                <p className="text-lg font-medium text-center mb-8 sm:mb-12">{t.logos.trustedBy}</p>
                <div className="w-full flex flex-wrap flex-row items-center justify-center gap-6 sm:gap-8 md:gap-10 logos-container">
