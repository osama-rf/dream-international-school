import { FaFacebook, FaGithub, FaInstagram, FaLinkedin, FaThreads, FaTwitter, FaXTwitter, FaYoutube, FaSnapchat, FaTiktok, FaWhatsapp } from "react-icons/fa6";
...
export const getPlatformIconByName = (platformName: string): JSX.Element | null => {
    switch (platformName) {
        ...
        case 'snapchat': {
            return <FaSnapchat size={24} className='min-w-fit' />;
        }
        case 'tiktok': {
